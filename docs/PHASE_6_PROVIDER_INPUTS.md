...
| Domain/DNS                | Stable TLS origin                 | Dedicated subdomain such as `control.example.com`                  | Render hostname temporarily                       | Domain can change, but sessions/origin/monitoring must rotate                   |
