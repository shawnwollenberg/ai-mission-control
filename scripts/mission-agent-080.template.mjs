...
const BUILD_SOURCE_COMMIT = "__MISSION_AGENT_BUILD_SOURCE_COMMIT__";
const ACCEPTANCE_BUILD_SOURCE_MANIFEST_SHA256 = "__MISSION_AGENT_ACCEPTANCE_SOURCE_MANIFEST_SHA256__";
const PROVIDER_RUNTIME_REQUIREMENTS = Object.freeze(__MISSION_AGENT_PROVIDER_RUNTIME_REQUIREMENTS__);
const PROVIDER_RUNTIME_PROFILES = Object.freeze(__MISSION_AGENT_PROVIDER_RUNTIME_PROFILES__);
