...
async function main() {
  ...
  const manifest: ReleaseManifestV3 = parseReleaseManifestV3({
    ...
    provenance: {
      builderSha256: option("--builder-sha256"),
      containerImageDigest: option("--container-image-digest"),
      manifestSchemaSha256: option("--manifest-schema-sha256"),
      nodeVersion: "22.22.0",
      packageLockSha256: option("--package-lock-sha256"),
      reproducibilityEvidenceSha256: option("--reproducibility-evidence-sha256"),
    },
